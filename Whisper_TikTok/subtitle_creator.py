...
def srt_create(whisper_model, path: str, series: str, part: int, filename: str, **kwargs) -> bool:
    ...
    transcribe.to_ass(str(absolute_ass_path), word_level=True, highlight_color=kwargs.get("font_color"), **word_dict)
    return ass_filename
